...
| `copy & import from camera` | ✅ Sì (da fotocamera USB/MTP) | ❌ No | ✅ Sì | ✅ Sì | Richiede che la fotocamera sia *unmounted* da altri processi prima di avviare darktable[^dt48-import]. |
...
[^dt48-import]: *darktable user manual — import & review*, [docs.darktable.org/usermanual/development/en/overview/workflow/import-review/](https://docs.darktable.org/usermanual/development/en/overview/workflow/import-review/)
...
[^dt48-import-review]: *darktable user manual — import & review*, sezione *Culling Process*, [docs.darktable.org/usermanual/development/en/overview/workflow/import-review/](https://docs.darktable.org/usermanual/development/en/overview/workflow/import-review/)
